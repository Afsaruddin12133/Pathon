...
const UpdateClass = () => {
    ...
    const fetchClassDetails = async () => {
      try {
        ...
        setClassDetails({
          ...
          tagList: Array.isArray(json.tagData)
            ? json.tagData.map((t) => t.title).join(",")
            : "",
          class: result.class || "",
  ...
  const handleUpdateLiveStatus = async (newStatus) => {
    ...
    try {
      ...
      setSuccess(
        `Class status updated to ${newStatus === 2 ? "Live" : "Ended"}!`
      );
    } catch (e) {
            ...
            {classItemId && (
              <div className="flex items-center gap-4">
                <div className="text-right">
                  ...
                  <p
                    className={`text-xs ${
                      liveStatus === 2 ? "text-green-600" : "text-red-600"
                    }`}
                  >
                ...
                <div className="relative">
                  <button
                    onClick={() =>
                      handleUpdateLiveStatus(liveStatus === 2 ? 1 : 2)
                    }
                ...
                <div className="flex flex-col text-xs text-gray-500">
                  <span
                    className={
                      liveStatus === 1 ? "font-semibold text-red-600" : ""
                    }
                  >
                    OFF
                  </span>
                  <span
                    className={
                      liveStatus === 2 ? "font-semibold text-green-600" : ""
                    }
                  >
                    ON
                  </span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setClassDetails({ ...classDetails, type: e.target.value })
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
                  >
