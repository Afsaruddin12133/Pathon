...
const handleCloseProblemSolving = async () => {
  ...
  if (!problemData) {
    return (
      <div className="p-4 text-gray-600">No problem details available.</div>
    );
  }
        ...
        {isOwner && (
          <div className="flex justify-end">
            <button
              type="button"
              onClick={
                details?.isClose === 0 ? handleCloseProblemSolving : undefined
              }
          ...
          <div>
            ...
            <div className="space-y-2">
              {problemItemsPdf.map((item, index) => (
                <div
                  key={item.id || index}
                  className="flex items-center p-3 border border-gray-200 rounded-xl bg-white shadow-sm"
                >
