...
const HeroResources = () => {
  return (
    <section className="bg-gray-100 py-12 sm:py-12 lg:px-40 xl:px-60 mx-auto max-w-7xl">
      ...
      <div className="mt-10 grid grid-cols-3 gap-4 sm:gap-4 justify-items-center">
        {CARDS.map(({ id, to, bg, icon, title1, title2 }) => (
          ...
          >
            <div
              className={`rounded-xl ${bg} text-white shadow-md hover:shadow-lg transition-shadow flex flex-col items-center justify-center p-4 sm:p-6 w-25 h-25 sm:w-40 sm:h-40 md:w-48 md:h-48`}
            >
