...
import Image from "../assets/Images/bank_logo.png";
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-5">
            ...
            <p className="mt-4 text-[14px] leading-6  max-w-[520px]">
              Welcome to Pathon, your dedicated partner in the world of
              education technology. At Pathon, we are driven by a singular
              mission: to empower learners and educators with innovative tools
              and resources that redefine the learning experience.
            </p>
          ...
          <div className="md:col-span-3 flex md:block items-start justify-start md:justify-end">
            <div className="space-y-6 md:ml-auto">
              ...
              {/* Google Play badge */}
              <a
                href="https://play.google.com/store/apps/details?id=app.pathon.https"
